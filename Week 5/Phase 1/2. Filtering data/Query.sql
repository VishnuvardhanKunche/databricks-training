...
WHERE price > 400; -- Output 1

-- 2. AND Condition
SELECT * FROM products
WHERE price > 200
  AND stock_quantity > 20; -- Output 2

-- 3. OR Condition
SELECT * FROM products
WHERE category = 'Electronics'
   OR price < 300; -- Output 3

-- 4. NOT Condition
SELECT *
FROM products
WHERE category <> 'Electronics'; -- Output 4

-- 5. Filtering with String Conditions
SELECT *
FROM products
WHERE price > 100
  AND category = 'Electronics'; -- Output 5

-- 6. IN Condition
SELECT *
FROM products
WHERE category IN ('Electronics', 'Sports'); -- Output 6

-- 7. Starts With
SELECT *
FROM products
WHERE category LIKE 'A%'; -- Output 7

-- 8. Ends With
SELECT *
FROM products
WHERE product_name LIKE '%er'; -- Output 8

-- 9. Pattern Matching (LIKE)
SELECT *
FROM products
WHERE product_name LIKE '%e%'; -- Output 9

-- 10. Regular Expression (Equivalent)
SELECT *
FROM products
WHERE product_name LIKE '%Wall%'; -- Output 10

-- 11. NULL Values
SELECT *
FROM products
WHERE price IS NULL; -- Output 11

-- 12. NOT NULL Values
SELECT *
FROM products
WHERE price IS NOT NULL; -- Output 12

-- 13. SQL Query
SELECT *
FROM products
WHERE stock_quantity > 50; -- Output 13